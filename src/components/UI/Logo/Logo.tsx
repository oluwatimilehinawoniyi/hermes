...
export default function Logo({ isLink = true, width }: LogoProps) {
  const logoSvg = (
    <svg
      id="Layer_2"
      data-name="Layer 2"
  ...
  if (isLink) {
    ...
    return (
      <div className={styles.dashboardlogo} style={{ width }}>
        {logoSvg}
      </div>
    );
  }
